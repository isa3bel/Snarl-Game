...
/**
 * Currently for the express purposes of the LocationQuery in the test harness, is a space is "walkable"?
 */
public class IsWalkable implements SpaceVisitor<Boolean> {
